// 28. Solving Boundary Value Problem using Shooting Method
...
// Define the first-order differential equations
...
float heun(float x0, float x1, float y0, float y1, float h) {
    ...
    printf("Calculation of y(%f) for guess value %f:", x1, y1);
    printf("\n x \t\t y(x)");
...
int main() {
    ...
    printf("Enter the first boundary conditions x and y(x): ");
    scanf("%f%f", &x0, &yx0);
